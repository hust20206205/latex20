...
% Chương 1: Trình bày cách thức phát triển phần mềm theo kiến trúc microservices.
...
% - Tổng quan về kiến trúc microservices: sự ra đời, đặc điểm của microservices
% - Các mẫu thiết kế quan trọng được sử dụng trong microservices
% - Một số nguyên tắc thiết kế microservices
...
% trúc microservices, micro-frontends. Một số nội dung chính trong quá trình thực nghiệm
% được làm rõ bao gồm:
% 3
% - Áp dụng phương pháp thiết kế hướng miền để phân hoạch, thiết kế chương trình
% - Thiết kế và cài đặt tầng dịch vụ theo hướng microservices, sử dụng các công
...
% - Một số kỹ thuật kiểm thử microservices cũng được thảo luận như kiểm thử đơn
