...
\input{contents/chapter2/chi_tiet_va_ap_dung_thiet_ke_huong_mien}

\section{Các mẫu chiến lược}

\input{contents/chapter2/part1/cac_mau_chien_luoc}

\newpage

\subsection{Miền phụ (Sub - Domain)}

\input{contents/chapter2/part1/mien_phu_sub_domain}

\subsubsection{Miền phụ chung (Generic Subdomain)}

\input{contents/chapter2/part1/mien_phu_chung_generic_subdomain}

\subsubsection{Miền phụ cốt lõi (Core Subdomain)}

\input{contents/chapter2/part1/mien_phu_cot_loi_core_subdomain}

\subsubsection{Miền phụ hỗ trợ (Supporting Subdomain)}

\input{contents/chapter2/part1/mien_phu_ho_tro_supporting_subdomain}

\newpage

\subsubsection{Cách xác định các miền phụ}

\input{contents/chapter2/part1/cach_xac_dinh_cac_mien_phu}

\newpage

\subsubsection{Áp dụng phân loại miền phụ trong đồ án này}

\input{contents/chapter2/part1/ap_dung_phan_loai_mien_phu_trong_do_an_nay}

\subsection{Mô hình miền (Domain Models)}

\input{contents/chapter2/part1/mo_hinh_mien_domain_models}

\subsection{Bối cảnh giới hạn (Bounded Context)}

\input{contents/chapter2/part1/boi_canh_gioi_han}

\subsection{Ngôn ngữ chung (Ubiquitous Language)}

\input{contents/chapter2/part1/ngon_ngu_chung}

\subsection{Bản đồ bối cảnh (Context Maps)}

% % \input{contents/chapter2/part1/ban_do_boi_canh_context_maps}


\subsection{Chi tiết về các mối quan hệ bối cảnh giới hạn}

% \input{contents/chapter2/chi_tiet_ve_cac_moi_quan_he_boi_canh_gioi_han}
